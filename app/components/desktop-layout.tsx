      ...
      <div className="relative min-h-screen w-full overflow-hidden bg-[#FDD835] flex flex-col pb-[150px] z-20">
        ...
        <div className="flex-1 flex flex-col justify-center w-full">
          ...
          <div className="relative w-full mt-auto h-full">
            ...
            <Image
              className="absolute bottom-0 left-0 z-20 h-fit w-full object-contain"
            ...
            {/* <div className="z-50 flex items-start justify-between gap-2 pointer-events-none w-full h-fit">
                <Image
                  src="/images/main-logo.webp"
                  alt="Logo"
                  width={250}
                ...
                <Image
                  ...
                  height={360}
                  alt="Người chấp tay"
                  className="h-auto w-full max-w-[280px] md:max-w-[350px] lg:max-w-[400px] object-contain pointer-events-auto translate-y-24 md:translate-y-32 relative z-50"
                  priority
                />
            </div> */}
          </div>
          ...
          <div className="max-w-9xl mx-auto">
            <Accordion type="single" collapsible className="w-full space-y-0">
              ...
              <AccordionItem value="item-4" className="border-none">
                <AccordionTrigger className="hover:no-underline bg-transparent text-black hover:bg-gray-50 text-left py-4 border-b border-gray-200 [&>svg]:text-black [&>svg]:rotate-0 [&[data-state=open]>svg]:rotate-180">
                  <span className="flex items-center justify-center text-base md:text-lg montserrat-500 underline flex-1 text-left">
                      Làm sao để cập nhật được lịch trình sự kiện diễn ra tại triễn lãm?
                  </span>
                </AccordionTrigger>
                <AccordionContent className="pt-4 pb-6 flex items-center justify-center">
                  <p className="text-sm md:text-base montserrat-400 text-black">
              ...
              <AccordionItem value="item-7" className="border-none">
                ...
                <AccordionContent className="pt-4 pb-6 flex items-center justify-center">
                  <p className="text-sm md:text-base montserrat-400 text-black">
                    Bạn có thể liên hệ qua email: info@ongganhbanang.com hoặc qua
