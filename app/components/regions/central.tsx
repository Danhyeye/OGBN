...
interface CentralDragDropGameProps {
  images: ImageItem[];
}

export default function CentralDragDropGame({ images }: CentralDragDropGameProps) {
  ...
  const [positions, setPositions] = useState<Position[]>([
    ...
    { id: "position-6", number: 6, imageId: null },
  ]);
      ...
      <div className="w-full h-full flex flex-col items-center justify-between gap-4 sm:gap-6 md:gap-8 relative z-10">
        ...
        >
            ...
            <Droppable droppableId="images-source" direction="horizontal">
              {(provided, snapshot) => (
                <div
                  ...
                  className={`flex flex-wrap items-center justify-center gap-2 sm:gap-3 md:gap-4 p-3 sm:p-4 md:p-6 rounded-lg border-2 transition-colors ${
          ...
          <div className="w-full max-w-6xl px-6 md:px-14 lg:px-24 pb-[8vh] sm:pb-[10vh] md:pb-[12vh] lg:pb-[14vh] xl:pb-[14vh] flex justify-center">
            <div className="flex items-end w-full flex-nowrap overflow-visible">
              {/* Left side: Positions 1, 2 */}
              <div className="flex items-end flex-1 justify-start">
                {/* Position 1 */}
                {(() => {
                      ...
                      >
                        {(provided, snapshot) => (
                          <div
                            ref={provided.innerRef}
                            {...provided.droppableProps}
                            className={`w-16 h-44 sm:w-20 sm:h-48 md:w-24 md:h-56 lg:w-32 lg:h-64 xl:w-40 xl:h-72 shrink-0 rounded-lg border-2 border-dashed relative transition-colors z-0 ${
                              snapshot.isDraggingOver
                                ? isLocked
                    ...
                    >
                      {(provided, snapshot) => (
                        <div
                          ref={provided.innerRef}
                          {...provided.droppableProps}
                          className={`w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 lg:w-32 lg:h-32 xl:w-40 xl:h-40 shrink-0 rounded-lg border-2 border-dashed relative transition-colors z-10 mr-2 sm:mr-4 md:mr-6 lg:mr-8 xl:mr-10 ${
                            snapshot.isDraggingOver
                              ? isLocked
                                ? "border-red-500 cursor-not-allowed"
                                : isOccupied
                    ...
                    >
                      {(provided, snapshot) => (
                        <div
                          ref={provided.innerRef}
                          {...provided.droppableProps}
                          className={`w-40 h-48 sm:w-48 sm:h-52 md:w-56 md:h-56 lg:w-64 lg:h-60 xl:w-72 xl:h-64 shrink-0 rounded-lg border-2 border-dashed relative transition-colors z-20 -mb-12 sm:-mb-14 md:-mb-16 lg:-mb-18 xl:-mb-20 ${
                            snapshot.isDraggingOver
                              ? isLocked
                                ? "border-red-500 cursor-not-allowed"
                                : isOccupied
                    ...
                    >
                      {(provided, snapshot) => (
                        <div
                          ref={provided.innerRef}
                          {...provided.droppableProps}
                          className={`w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 xl:w-28 xl:h-28 shrink-0 rounded-lg border-2 border-dashed relative transition-colors z-10 -ml-4 sm:-ml-6 md:-ml-8 lg:-ml-10 xl:-ml-12 ${
                            snapshot.isDraggingOver
                              ? isLocked
                                ? "border-red-500 cursor-not-allowed"
                                : isOccupied
                    ...
                    >
                      {(provided, snapshot) => (
                        <div
                          ref={provided.innerRef}
                          {...provided.droppableProps}
                          className={`w-32 h-44 sm:w-36 sm:h-48 md:w-44 md:h-56 lg:w-52 lg:h-64 xl:w-60 xl:h-72 shrink-0 rounded-lg border-2 border-dashed relative transition-colors z-0 -ml-4 sm:-ml-6 md:-ml-8 lg:-ml-10 xl:-ml-12 ${
                            snapshot.isDraggingOver
                              ? isLocked
                                ? "border-red-500 cursor-not-allowed"
                                : isOccupied
