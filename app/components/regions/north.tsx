...
interface NorthDragDropGameProps {
  images: ImageItem[];
}

export default function NorthDragDropGame({ images }: NorthDragDropGameProps) {
    ...
    <div className="w-full h-full relative">
      ...
      <div className="w-full h-full flex flex-col items-center justify-between gap-4 sm:gap-6 md:gap-8 relative z-10">
        ...
        >
          ...
          <div className="w-full max-w-6xl px-6 md:px-16 lg:px-24 pb-[8vh] sm:pb-[10vh] md:pb-[12vh] lg:pb-[14vh] xl:pb-[14vh] flex justify-center">
            <div className="flex items-end w-full flex-nowrap overflow-visible">
                          ...
                          <div
                            ...
                            className={`w-16 h-44 sm:w-20 sm:h-48 md:w-24 md:h-56 lg:w-32 lg:h-64 xl:w-40 xl:h-72 shrink-0 rounded-lg border-2 border-dashed relative transition-colors z-0 ${
                              snapshot.isDraggingOver
                                ...
                                ? "border-gray-300"
                                : "border-gray-400"
                            } mr-2 sm:mr-2.5 md:mr-3 lg:mr-4 xl:mr-6`}
                          >
                            {position.imageId ? (
                              <Draggable
                      ...
                      >
                        {(provided, snapshot) => (
                          <div
                            ref={provided.innerRef}
                            {...provided.droppableProps}
                            className={`w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 lg:w-32 lg:h-32 xl:w-40 xl:h-40 shrink-0 rounded-lg border-2 border-dashed relative transition-colors z-10 ${
                              snapshot.isDraggingOver
                                ? isLocked
                                  ? "border-red-500 cursor-not-allowed"
                                  : isOccupied
              ...
              {/* Right side: Positions 5, 6 */}
              <div className="flex items-center gap-2 sm:gap-2.5 md:gap-3 lg:gap-4 xl:gap-6 flex-1 justify-end">
                {positions.slice(4).map((position) => {
                  ...
                  const isLocked = position.imageId
                    ...
                    : false;
                  const isPosition5 = position.number === 5;
                  return (
                    <Droppable
                      key={position.id}
                      droppableId={position.id}
                    ...
                    >
                      {(provided, snapshot) => (
                        <div
                          ...
                          } shrink-0 rounded-lg border-2 border-dashed relative transition-colors z-0 ${
                            snapshot.isDraggingOver
                              ? isLocked
                                ? "border-red-500 cursor-not-allowed"
                                : isOccupied
